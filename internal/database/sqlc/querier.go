...
type Querier interface {
	...
	GetLegacyCallMetrics(ctx context.Context) ([]GetLegacyCallMetricsRow, error)
	...
	GetTransactionStateCounts(ctx context.Context) ([]GetTransactionStateCountsRow, error)
