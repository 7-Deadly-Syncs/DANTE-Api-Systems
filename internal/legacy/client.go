...
func (c *Client) Ping(ctx context.Context) error {
	...
	ctx, span := tracing.StartClientSpan(ctx, "legacy", "legacy.ping",
		...
		attribute.String("url.full", c.wsdlURL()),
		attribute.String("legacy.system", "bankservice"),
...
func (c *Client) callOperation(ctx context.Context, operation string, args ...string) (string, error) {
	...
	ctx, span := tracing.StartClientSpan(ctx, "legacy", "legacy."+operation,
		attribute.String("http.request.method", http.MethodPost),
		attribute.String("url.full", c.endpoint),
		attribute.String("legacy.system", "bankservice"),
